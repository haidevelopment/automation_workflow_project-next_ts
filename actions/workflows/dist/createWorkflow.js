...
var workflow_2 = require("@/types/workflow");
...
function CreateWorkflow(form) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, success, data, userId, initialFlow, result;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = workflow_1.workflowSchema.safeParse(form), success = _a.success, data = _a.data;
                    if (!success) {
                        throw new Error("invalid form data");
                    }
                    return [4 /*yield*/, server_1.auth()];
                case 1:
                ...
                case 2:
                    ...
                    navigation_1.redirect("/workflow/editor/" + result.id);
                    return [2 /*return*/];
            }
        });
    });
