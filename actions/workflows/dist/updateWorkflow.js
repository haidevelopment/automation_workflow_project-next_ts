...
function UpdateWorkflow(_a) {
    var id = _a.id, definition = _a.definition;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (workflow.status !== workflow_1.WorkflowStatus.DRAF) {
                        throw new Error("Workflow is not a Draf");
                    }
                    return [4 /*yield*/, prisma_1["default"].workflow.update({
                            data: {
                ...
                case 3:
                    _b.sent();
                    cache_1.revalidatePath("/workflows");
                    return [2 /*return*/];
            }
        });
    });
